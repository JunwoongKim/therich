...
,new ConditionWithArgument('`member`.`member_srl`',$member_srls4_argument,"in", 'and')),'and')
,new ConditionGroup(array(
...
,new ConditionWithArgument('`member`.`last_login`',$s_last_login_less17_argument,"less", 'or')),'and')
));
