...
${'last_updater32_argument'} = new Argument('last_updater', $args->{'last_updater'});
if(!${'last_updater32_argument'}->isValid()) return ${'last_updater32_argument'}->getErrorMessage();
} else
${'last_updater32_argument'} = NULL;if(${'last_updater32_argument'} !== null) ${'last_updater32_argument'}->setColumnType('varchar');
...
${'update_order35_argument'}->ensureDefaultValue('0');
if(!${'update_order35_argument'}->isValid()) return ${'update_order35_argument'}->getErrorMessage();
if(${'update_order35_argument'} !== null) ${'update_order35_argument'}->setColumnType('number');

${'allow_trackback36_argument'} = new Argument('allow_trackback', $args->{'allow_trackback'});
${'allow_trackback36_argument'}->ensureDefaultValue('Y');
if(!${'allow_trackback36_argument'}->isValid()) return ${'allow_trackback36_argument'}->getErrorMessage();
if(${'allow_trackback36_argument'} !== null) ${'allow_trackback36_argument'}->setColumnType('char');

${'notify_message37_argument'} = new Argument('notify_message', $args->{'notify_message'});
${'notify_message37_argument'}->ensureDefaultValue('N');
if(!${'notify_message37_argument'}->isValid()) return ${'notify_message37_argument'}->getErrorMessage();
if(${'notify_message37_argument'} !== null) ${'notify_message37_argument'}->setColumnType('char');

${'status38_argument'} = new Argument('status', $args->{'status'});
${'status38_argument'}->ensureDefaultValue('PUBLIC');
if(!${'status38_argument'}->isValid()) return ${'status38_argument'}->getErrorMessage();
if(${'status38_argument'} !== null) ${'status38_argument'}->setColumnType('varchar');

${'commentStatus39_argument'} = new Argument('commentStatus', $args->{'commentStatus'});
${'commentStatus39_argument'}->ensureDefaultValue('ALLOW');
if(!${'commentStatus39_argument'}->isValid()) return ${'commentStatus39_argument'}->getErrorMessage();
if(${'commentStatus39_argument'} !== null) ${'commentStatus39_argument'}->setColumnType('varchar');
...
,new InsertExpression('`last_updater`', ${'last_updater32_argument'})
,new InsertExpression('`ipaddress`', ${'ipaddress33_argument'})
,new InsertExpression('`list_order`', ${'list_order34_argument'})
,new InsertExpression('`update_order`', ${'update_order35_argument'})
,new InsertExpression('`allow_trackback`', ${'allow_trackback36_argument'})
,new InsertExpression('`notify_message`', ${'notify_message37_argument'})
,new InsertExpression('`status`', ${'status38_argument'})
,new InsertExpression('`comment_status`', ${'commentStatus39_argument'})
));
