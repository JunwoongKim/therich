...
<h1 class="h1"><?php echo $__Context->lang->msg_update_member ?></h1>
...
.xpress-editor>#smart_content>.tool{clear:none}
	...
	<div class="group"><div class="btnArea btn-group pull-right">
		<input type="submit" value="<?php echo $__Context->lang->cmd_registration ?>" class="btn btn-primary" />
		<a href="<?php echo getUrl('act','dispMemberInfo','member_srl','') ?>" class="btn"><?php echo $__Context->lang->cmd_cancel ?></a>
	</div></div>
</form>
</div>
<script>
