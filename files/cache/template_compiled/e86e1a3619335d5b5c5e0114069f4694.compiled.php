...
require_once('./classes/xml/XmlJsFilter.class.php');$__xmlFilter=new XmlJsFilter('modules/easyxe/tpl/_extends/page/filter','insert_page_content.xml');$__xmlFilter->compile(); ?>
<!--#Meta:modules/easyxe/tpl/_extends/page/css/skins/cm_default/style.css--><?php $__tmp=array('modules/easyxe/tpl/_extends/page/css/skins/cm_default/style.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/easyxe/tpl/_extends/page/js/jquery.jeegoocontext-2.0.0.js--><?php $__tmp=array('modules/easyxe/tpl/_extends/page/js/jquery.jeegoocontext-2.0.0.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/easyxe/tpl/_extends/page/js/page_admin.js--><?php $__tmp=array('modules/easyxe/tpl/_extends/page/js/page_admin.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/easyxe/tpl/_extends/page/js/page_modify.js--><?php $__tmp=array('modules/easyxe/tpl/_extends/page/js/page_modify.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/easyxe/tpl/_extends/page/css/page.css--><?php $__tmp=array('modules/easyxe/tpl/_extends/page/css/page.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
