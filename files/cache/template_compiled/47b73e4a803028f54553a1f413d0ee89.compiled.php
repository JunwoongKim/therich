...
$__Context->week=$__Context->Model->getWeek($__Context->selected_date) ?>
<?php $__Context->position=1+($__Context->user_data->page-1)*20 ?>
<div class="center"><?php echo $__Context->monday = zDate(date("YmdHis",strtotime($__Context->week->monday)),"Y-m-d") ?> ~ <?php echo $__Context->sunday = zDate(date("YmdHis",strtotime($__Context->week->sunday)),"Y-m-d") ?></div><br/>
...
<table cellspacing="0" class="rowTable attendanceTable" >
	<tr>
		...
		<th style="width:300px;" class="center">
			<?php echo $__Context->lang->view_weekly_day ?>
		</th>
		<td class="center">
			<?php echo $__Context->lang->view_weekly_point ?>
		</td>
	</tr>
...
<tr>
	...
	<th style="width:300px;">
			<div class="admin_graph">
				<?php $__Context->percent=(int)($__Context->ranking->weekly/7 * 100) ?>
...
echo $__Context->percent ?>%<?php };
					...
					<strong><?php echo $__Context->ranking->weekly ?></strong>/7<?php if($__Context->percent<50){ ?>(<?php echo $__Context->percent ?>%)<?php } ?>
					</div>
        		</div>
	</th>
	<td class="center">
		<?php echo $__Context->ranking->weekly_point ?>
	</td>
</tr>
