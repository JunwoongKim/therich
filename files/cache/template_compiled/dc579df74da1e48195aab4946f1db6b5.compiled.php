        ...
        <div class="replyItem <?php if($__Context->comment->get('depth')){ ?>reply<?php } ?>">
            ...
            <div class="replyOption">
                <?php if($__Context->comment->isGranted() || !$__Context->comment->get('member_srl')){ ?>
                    <a href="<?php echo getUrl('act','dispBoardDeleteComment','comment_srl',$__Context->comment->comment_srl) ?>"><img src="/modules/board/skins/board_skin(planner_title)/images/common/buttonDeleteX.gif" alt="<?php echo $__Context->lang->cmd_delete ?>" width="12" height="13" /></a>
                    <a href="<?php echo getUrl('act','dispBoardModifyComment','comment_srl',$__Context->comment->comment_srl) ?>"><img src="/modules/board/skins/board_skin(planner_title)/images/<?php echo $__Context->module_info->colorset ?>/buttonModifyE.gif" alt="<?php echo $__Context->lang->cmd_modify ?>" width="20" height="17" /></a> 
                <?php } ?>
                    <a href="<?php echo getUrl('act','dispBoardReplyComment','comment_srl',$__Context->comment->comment_srl) ?>"><img src="/modules/board/skins/board_skin(planner_title)/images/<?php echo $__Context->module_info->colorset ?>/buttonReply.gif" alt="<?php echo $__Context->lang->cmd_reply ?>" width="20" height="17" /></a> 
            </div>
            <div class="date">
