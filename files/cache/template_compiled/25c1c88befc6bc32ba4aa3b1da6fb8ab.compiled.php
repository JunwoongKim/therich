...
<?php if($__Context->pad == 29){ ?>
	<?php $__Context->eoy = 366 ?>
<?php }else{ ?>
	<?php $__Context->eoy = 365 ?>
<?php } ?>
...
<table cellspacing="0" class="rowTable attendanceTable">
	<tr>
		...
		<th width="40%" style="min-width:240px;" class="center">
			<?php echo $__Context->lang->view_yearly_day ?>
		</th>
		<td class="center">
			<?php echo $__Context->lang->view_yearly_point ?>
		</td>
	</tr>
...
<tr>
	<th class="center"> 
		<div class="center"><?php echo $__Context->position ?></div>
	</th>
	<td class="center"> 
	...
	<th width="40%" style="min-width:240px;">
			<div class="admin_graph">
				<?php $__Context->percent=(int)($__Context->ranking->yearly/$__Context->eoy * 100) ?>
...
echo $__Context->percent ?>%<?php };
					...
					<strong><?php echo $__Context->ranking->yearly ?></strong>/<?php echo $__Context->eoy;
if($__Context->percent<50){ ?>(<?php echo $__Context->percent ?>%)<?php } ?>
					</div>
        		</div>
	</th>
	<td class="center">
		<?php echo $__Context->ranking->yearly_point ?>
	</td>
</tr>
