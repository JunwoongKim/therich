...
echo $__Context->file->download_url ?>"><?php echo $__Context->file->source_filename ?> (<?php echo FileHandler::filesize($__Context->file->file_size) ?>)(<?php echo number_format($__Context->file->download_count) ?>)</a></li>
    ...
    <div class="contentButton">
        ...
        <a href="<?php echo getUrl('document_srl','') ?>" class="button <?php echo $__Context->btn_class ?>"><span><?php if($__Context->module_info->default_style != 'blog'){;
...
<?php if($__Context->oDocument->allowTrackback()){ ?>
    <?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/board_skin(planner_title)','trackback.html') ?>
<?php } ?>
<!-- 댓글 -->
<a name="comment"></a>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/board_skin(planner_title)','comment.html') ?>
<!-- 댓글 입력 폼 -->
