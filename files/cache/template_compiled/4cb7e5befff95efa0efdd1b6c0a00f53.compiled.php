<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/easyxe/tpl/_extends/page/js/page_admin.js--><?php $__tmp=array('modules/easyxe/tpl/_extends/page/js/page_admin.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
