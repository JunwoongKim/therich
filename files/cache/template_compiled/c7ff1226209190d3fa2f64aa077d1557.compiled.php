...
$__Context->_logo_img = 's_logo.png';
						...
						<img src="<?php echo $__Context->layout_info->path ?>img/<?php echo $__Context->_logo_img ?>"<?php if($__Context->_onepage_header){ ?> data-logo="<?php echo $__Context->layout_info->path ?>img/logo.png"<?php } ?> alt="THE RICH" />
					<?php } ?>
				</a>
			</h1>
